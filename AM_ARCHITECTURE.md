...
> **문서 버전:** v0.11 (Day 8 작업1 재검증 결과 반영 — 기대와 다르게 개선 안 됨, §16.13.1)
> **최초 작성일:** 2026-03-24
> **최종 수정일:** 2026-07-05
> **상태:** POC Day 7 완료. Day 8 진행 중 — 요청 라인 분리 구현·기동 완료했으나 TS-0009 재검증 결과 미개선, 원인 재진단 필요
...
*문서 끝 — 다음 업데이트: TS-0009 재실행 시 NiFi/Kafka 리소스 사용률 실측 확인 후, 원인 확정 및 조치 방향 결정 (v0.11)*
